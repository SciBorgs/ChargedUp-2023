...
public class BetterElevatorFeedforward {
  ...
  /**
   * Creates a new BetterElevatorFeedforward with the specified gains. Units of the gain values will
  ...
  /**
   * Creates a new BetterElevatorFeedforward with the specified gains. Acceleration gain is
  ...
  public double calculate(double velocity, double acceleration) {
    return base.calculate(velocity, acceleration) + kg;
  }
  ...
  public double calculate(double currentVelocity, double nextVelocity, double dtSeconds) {
    return base.calculate(currentVelocity, nextVelocity, dtSeconds) + kg;
  }
  ...
  public double maxAchievableVelocity(double maxVoltage, double acceleration) {
    ...
    return (maxVoltage - base.ks - kg - acceleration * base.ka) / base.kv;
  }
  ...
  public double maxAchievableAcceleration(double maxVoltage, double velocity) {
    return (maxVoltage - base.ks * Math.signum(velocity) - kg - velocity * base.kv) / base.ka;
  }
