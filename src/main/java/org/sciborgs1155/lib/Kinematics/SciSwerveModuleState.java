...
public class SciSwerveModuleState extends SwerveModuleState{
    ...
    public static SciSwerveModuleState optimize(SciSwerveModuleState desiredState, Rotation2d currentAngle){
        ...
        if (Math.abs(delta.getDegrees()) > 90.0) {
            ...
            return new SciSwerveModuleState(desiredState.moduleAcceleration, desiredState.speedMetersPerSecond, desiredState.angle);
          }
    }
