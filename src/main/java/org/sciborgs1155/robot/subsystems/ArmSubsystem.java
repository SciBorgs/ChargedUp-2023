...
public class ArmSubsystem {
    private final CANSparkMax[] armMotors = Motors.armMotorConfig.buildCanSparkMax(MotorType.kBrushless, ArmPorts.armPorts);
    ...
    private final ProfiledPIDController armFeedback = new ProfiledPIDController(
        ArmConstants.P,
        ArmConstants.I, 
        ArmConstants.D, 
    ...
    public void setArmPosition(double position){
        ...
        double ff = armFeedforward.calculate(armFeedback.getSetpoint().position, armFeedback.getSetpoint().velocity);
