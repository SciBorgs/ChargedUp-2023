...
public class ElevatorIOSim implements ElevatorIO {
    ...
    public ElevatorIOSim(PIDConstants pid, SystemConstants ff, ElevatorConfig config, boolean gravity) {
        sim = new ElevatorSim(config.gearbox(), config.gearing(), config.mass(), config.sprocketRadius(), config.minHeight(), config.maxHeight(), gravity);
        this.pid = pid.create();
