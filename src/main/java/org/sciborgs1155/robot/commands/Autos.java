...
//     public static final List<PathPlannerTrajectory> CONE_LEAVE_BUMP = loadPath("cone leaveComm
// b");
//     public static final List<PathPlannerTrajectory> CONE_LEAVE_FLAT = loadPath("cone leaveComm
// f");

//     public static final List<PathPlannerTrajectory> CUBE_LEAVE_BUMP = loadPath("cube leaveComm
// b");
//     public static final List<PathPlannerTrajectory> CUBE_LEAVE_FLAT = loadPath("cube leaveComm
// f");
...
//      * starting location: against grid, to one side (it should have a clear path straight
// forward)
//      */
...
//             rotation);
//     return Commands.runOnce(
//         () -> drive.resetOdometry(transformPoseForAllaince(bluePose,
