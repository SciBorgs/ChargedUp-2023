...
//     return odometryAlign(drive.getPose());
//   }

//   public Command odometryAlign(Pose2d startPose, GamePiece gamePiece) {
//     return drive.driveToPose(startPose, closestScoringPoint(startPose, side), true);
//   }

//   private Pose2d closestScoringPoint(Pose2d pose, Side side, GamePiece gamePiece) {
...
// replace scoring points with pose2d
