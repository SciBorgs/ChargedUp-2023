...
public final class Constants {
  public static final class Motors {
    public static final MotorConfig moduleDriveConfig = MotorConfig.base().setNeutralBehavior(NeutralBehavior.BRAKE)
        .setCurrentLimit(50);

    public static final MotorConfig moduleTurnConfig = MotorConfig.base().setNeutralBehavior(NeutralBehavior.BRAKE)
        .setCurrentLimit(20);
  }
  ...
  public static final class ModuleConstants {
    ...
    public final class Driving {
      public static final double ENCODER_POSITION_FACTOR = (kWheelDiameterMeters * Math.PI) / kDrivingMotorReduction;
    ...
    public static final class Turning {
      ...
      public static final TrapezoidProfile.Constraints CONSTRAINTS = new TrapezoidProfile.Constraints(MAX_ANGULAR_SPEED,
