...
public final class Constants {
  ...
  public static final class Drive {
    ...
    public static final SciSwerveKinematics DRIVERKINEMATICS =
        new SciSwerveKinematics(MODULE_OFFSET);
    public static final SwerveDriveKinematics AUTOKINEMATICS =
        new SwerveDriveKinematics(MODULE_OFFSET);
