...
public final class Constants {
  public static final class Motors {
    ...
    public static final MotorConfig armMotorConfig =
        MotorConfig.base().withNeutralBehavior(NeutralBehavior.BRAKE).withCurrentLimit(50);
    public static final MotorConfig wristMotorConfig =
  ...
  public static final class ElevatorConstants {
    ...
    public static final double MAX_VECOCITY = 0.3; // m/s
    public static final double MAX_ACCELERATION = 0.3; // m/s^2
    ...
    public static final TrapezoidProfile.Constraints CONSTRAINTS =
        new TrapezoidProfile.Constraints(MAX_VECOCITY, MAX_ACCELERATION);
    public static final double GEAR_RATIO = 1.0;
    public static final double DISTANCEPERSPROCKETSPIN = 1.1938 / 6.0; // m/ (50 rotations of motor)
  }
  ...
  public static final class WristConstants {
    ...
    public static final TrapezoidProfile.Constraints CONSTRAINTS =
        new TrapezoidProfile.Constraints(maxVelocity, maxAcceleration);
    public static final double GEAR_RATIO = 1.0;
    public static final double MOVEMENTPERSPIN = (2 * Math.PI); // radians
  }
