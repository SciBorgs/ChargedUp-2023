...
public class PlacementDynamicsTest {
  ...
  public static final PlacementDynamics model =
      new PlacementDynamics(
          ...
          new MotorConstants(ElevatorConstants.MECHANISM_GEAR_RATIO, 3, 0.1),
          new MotorConstants(ElbowConstants.MECHANISM_GEAR_RATIO, 2, 0.1),
          new MotorConstants(WristConstants.MECHANISM_GEAR_RATIO, 1, 0.1),
